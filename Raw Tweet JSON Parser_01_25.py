...
#Old Version
#original tweet (tweet, reply, the seed content of a retweet, the seed content of a quote and quote* and quote & retweet)
#meso tweet (the quote part of a quote & retweet)
#ultima tweet (the whole tweet of a quote or a reply)
...
def main():
    for data_dir in data_dirs:
        with open(data_dir + '_log_' + time.strftime("%Y%m%d_%H%M%S") + '.txt', 'w') as data_log_writer:
            data_log_writer.write("filename,\ttotal_lines,\tmatched_lines\n")
            for data_path in Path(data_dir).iterdir():

                start_time = time.time()
                print("Reading tweets from " + data_path.name + " :")

                total_count, matched_count = process_file(data_path)

                data_log_writer.write("{},\t{},\t{}\n".format(data_path, total_count, matched_count))
...
def process_file(data_path):
    ...
    log_path = log_dir + '/' + data_path.with_suffix('.jsonl').name
    csv_path = csv_dir + '/' + data_path.with_suffix('.csv').name

    with jsonlines.open(log_path, 'w') as log_writer:
        with open(csv_path, 'w') as _csv_writer:
            ...
            with jsonlines.open(data_path) as reader:
                for obj in tqdm(reader):
                    ...
                    _matched_count = process_line(obj, csv_writer, log_writer)
...
def process_line(obj, csv_writer, log_writer):
    ...
    if 'lang' in obj and obj['lang'] == 'en':
        ...
        if True:
            ...
            if obj['in_reply_to_user_id']: #not zero/None or False
                _category = 'reply'

            else:
                if "retweeted_status" in obj:
                    if "quoted_status" in obj['retweeted_status']:
            ...
            try:
                ...
                if _category == 'retweet&quote':
                    ...
                    quoted_media_type = obj['retweeted_status']['extended_entities']['media'][0]['type'] if 'extended_entities' in obj['retweeted_status'] else 'no media' #determine the type by checking the first media
                    seed_media_type = obj['retweeted_status']['quoted_status']['extended_entities']['media'][0]['type'] if 'extended_entities' in obj['retweeted_status']['quoted_status'] else 'no media' #same
                    ...
                    seed_media_urls = [item['media_url'] for item in obj['retweeted_status']['quoted_status']['extended_entities']['media']] if 'extended_entities' in obj['retweeted_status']['quoted_status'] else 'no url'#same


                    _tweet_full += ':' + obj['retweeted_status']['full_text'] + ' RT @' + obj['retweeted_status']['quoted_status']['user']['screen_name'] + ': ' + obj['retweeted_status']['quoted_status']['full_text']
                    quoted_hashtags = [item['text'] for item in obj['retweeted_status']['entities']['hashtags']] #hashtags in quote comment
                    seed_hashtags= [item['text'] for item in obj['retweeted_status']['quoted_status']['entities']['hashtags']] #hashtags in seed tweet
                    quoted_user_mentions = [item for item in obj['retweeted_status']['entities']['user_mentions']] #keep raw format
                    seed_user_mentions = [item for item in obj['retweeted_status']['quoted_status']['entities']['user_mentions']]#keep raw format
                    quoted_urls = [item['url'] for item in obj['retweeted_status']['entities']['urls']] #URLs included in the text of quote comment (the default one is the link of original tweet, if more than 1 means additional link exists)
                    seed_urls = [item['url'] for item in obj['retweeted_status']['quoted_status']['entities']['urls']] #URLs included in the text of seed tweet
                    ...
                    _seed_tweet_favorite_count = obj['retweeted_status']['quoted_status']['favorite_count'] #favorites of the seed tweet
                    _seed_tweet_retweet_count = obj['retweeted_status']['quoted_status']['retweet_count'] #retweets of the seed tweet
                    ...
                    _seed_account_id_str = obj['retweeted_status']['quoted_status']['user']['id_str']
                    _seed_account_name = obj['retweeted_status']['quoted_status']['user']['name']
                    _seed_account_screen_name = obj['retweeted_status']['quoted_status']['user']['screen_name']
                    _seed_account_followers_count = obj['retweeted_status']['quoted_status']['user']['followers_count']
                    _seed_account_friends_count = obj['retweeted_status']['quoted_status']['user']['friends_count']
                    _seed_account_statuses_count = obj['retweeted_status']['quoted_status']['user']['statuses_count']
                    _seed_account_created_time = obj['retweeted_status']['quoted_status']['user']['created_at']
                    _seed_account_verified = obj['retweeted_status']['quoted_status']['user']['verified']
                    _seed_account_description = obj['retweeted_status']['quoted_status']['user']['description']
                    _seed_account_url = obj['retweeted_status']['quoted_status']['user']['url']
                    _seed_account_source = obj['retweeted_status']['quoted_status']['source'].split(">")[1].split("<")[0]

                    _meso_part_created_at = obj['retweeted_status']['created_at']
                    _seed_part_created_at = obj['retweeted_status']['quoted_status']['created_at']



                if _category == 'retweet':
                    quoted_media_type = 'not applied'
                    seed_media_type = obj['retweeted_status']['extended_entities']['media'][0]['type'] if 'extended_entities' in obj['retweeted_status'] else 'no media'
                    ...
                    _tweet_full = 'RT @' + obj['retweeted_status']['user']['screen_name'] + ':' + obj['retweeted_status']['full_text']
                ...
                if _category == 'quote':
                    ...
                    seed_media_type = obj['quoted_status']['extended_entities']['media'][0]['type'] if 'extended_entities' in obj['quoted_status'] else 'no media'
                    quoted_media_urls = [item['media_url'] for item in obj['extended_entities']['media']] if 'extended_entities' in obj else 'no url'
                    ...
                    _tweet_full = obj['full_text'] + ' RT @' + obj['quoted_status']['user']['screen_name'] + ':' + obj['quoted_status']['full_text']
                ...
                if _category == 'reply':
                    ...
                    quoted_media_type = 'not applied'
                    seed_media_type = obj['extended_entities']['media'][0]['type'] if 'extended_entities' in obj else 'no media'
                    quoted_media_urls = 'not applied'
                    seed_media_urls = [item['media_url'] for item in obj['extended_entities']['media']] if 'extended_entities' in obj else 'no url'


                    _tweet_full = 'Replying to ' + obj['full_text']
                ...
                row_content = [
                    ...
                    "None", #'tweet_seed_quote_count'; Rehydrate JSONs do not have obj['quote_count']
                    "None", #'tweet_seed_reply_count'; Rehydrate JSONs do not have obj['reply_count']
                    _seed_tweet_favorite_count, #'tweet_seed_favorite_count'
                    _seed_tweet_retweet_count, #'tweet_seed_retweet_count'
                    "None", #'tweet_quote_count';Rehydrate JSONs do not have obj['quote_count'] for seed tweet
                    "None",#'tweet_reply_count';Rehydrate JSONs do not have obj['reply_count'] for seed tweet
